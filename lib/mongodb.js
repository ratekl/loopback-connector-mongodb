...
/**
 * Get optional database name for a given model
 * @param {String} modelName Model name
 * @returns {String} database name or null if not specified
 */
MongoDB.prototype.databaseName = function(modelName) {
  var modelClass = this._models[modelName];
  var databaseName = null;
  if (modelClass.settings.mongodb) {
    databaseName = modelClass.settings.mongodb.database || null;
  }
  return databaseName;
};
 ...
 * @returns {*}
 */
MongoDB.prototype.database = function(modelName) {
  var database = this.db;
  var databaseName = this.databaseName(modelName);
  if (databaseName) {
...
MongoDB.prototype.collection = function(modelName) {
  ...
  var database = this.database(modelName);
