 ...
 */
MongoDB.prototype.databaseName = function(model) {
 ...
 * @returns {*}
 */
MongoDB.prototype.database = function(model) {
  var database = this.db;
  var databaseName = this.databaseName(model);
  if (databaseName) {
...
MongoDB.prototype.collection = function(modelName) {
  ...
  var database = this.database(model);
